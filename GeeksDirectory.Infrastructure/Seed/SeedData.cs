...
using GeeksDirectory.Infrastructure.Models;
...
namespace GeeksDirectory.Infrastructure.Seed
{
    internal class SeedData
    {
        ...
        private IEnumerable<ProfilesSeed> GetProfilesData()
        {
            yield return new ProfilesSeed()
            {
        ...
        private IEnumerable<SkillSeed> GetSkillsData()
        {
            var random = new Random();

            var data = new List<SkillSeed>()
                {
                    new SkillSeed() { Name = "csharp", Description = "Lorem ipsum dolor sit amet."},
                    new SkillSeed() { Name = "javascript", Description = "Quis autem eum iur velit esse quam."},
                    new SkillSeed() { Name = "angular", Description = "Nemo enim sit aspernatur aut odit."},
                    new SkillSeed() { Name = "java", Description = "Ut enim ad minima, exercitationem ullam."},
                    new SkillSeed() { Name = "python", Description = "Excepteur sint in culpa id est laborum."},
                    new SkillSeed() { Name = "cpp", Description = "Excepteur occaecat cupida proident, suntid est."},
                    new SkillSeed() { Name = "php", Description = "Quis autem vel eum iure repreherit in ea quam."},
                    new SkillSeed() { Name = "swift", Description = "Nemo enim ipsam voptatem aut odit."},
                    new SkillSeed() { Name = "ruby", Description = "Excepteur sint cupitat, anim id est laborum."},
                    new SkillSeed() { Name = "objective_c", Description = "Ut enim ad exercitationem ullam."},
                    new SkillSeed() { Name = "sql", Description = "Excepteur sint occaecat prodent, est laborum."}
                };
