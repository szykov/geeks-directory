...
export const getLoadingStatus = (state: State): boolean => state.loading;
export const getCollection = (state: State): IProfilesEnvelope => state.collection;
export const getSelectedProfile = (state: State): IProfile => state.selected;
export const getSearchedProfiles = (state: State): IProfilesEnvelope => state.searched;
