...
export const getScrollPosition = (state: State): ScrollPosition => state.scrollPosition;
export const getIsMobileFlag = (state: State): boolean => state.isMobile;
export const getSidebar = (state: State): ISideBar => state.sidebar;
